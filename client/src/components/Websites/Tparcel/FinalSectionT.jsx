...
import { FiHeadphones, FiRefreshCw, FiAward, FiUsers } from "react-icons/fi";
...
export default function FinalSection() {
    ...
    "
            ...
            <div className="max-w-6xl mx-auto text-center py-16 select-none">
                <h3 className="text-[22px] font-bold text-black">Why Choose TPARCEL?</h3>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 mt-10 text-center">
                    ...
                    <div>
                        <FiHeadphones className="text-blue-600 text-3xl mx-auto" />
                    ...
                    <div>
                        <FiRefreshCw className="text-blue-600 text-3xl mx-auto" />
                    ...
                    <div>
                        <FiUsers className="text-blue-600 text-3xl mx-auto" />
            ...
            <div className="mt-10 w-full px-[15px] mb-[25px]">
                <div
                    className="
      relative w-full max-w-7xl mx-auto mb-20
    ...
    "
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-linear-to-r to-transparent z-0"></div>

                    {/* LEFT TEXT CONTENT */}
                    <div className="relative z-10 px-8 md:px-14 max-w-xl text-white mt-20 select-none">
                        <h2
                            className="
    font-sora
    font-normal
  ...
  "
                        >
                            Build Your Own Ride-Sharing <br />
                            Business <span className="font-bold">Today!</span>
                        </h2>
  ...
  "
                        >
                            Everything you need to launch a powerful ride- <br />
                            sharing platform in minutes.
                        </p>
        ...
        "
            ...
            <footer className="w-full bg-[#0B0E16] text-white py-14">
                ...
                {/* ---- Add below your existing footer content ---- */}
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-xs mt-5 px-6">
                    ...
                    <div className="flex items-center gap-4 text-white text-lg">
                        ...
                        <FaGithub className="cursor-pointer hover:text-gray-200 transition" />
                    </div>
                </div>
            </footer>
        </section>
